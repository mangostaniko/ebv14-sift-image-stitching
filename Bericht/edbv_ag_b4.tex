...
\subsection{Methodik}
Der folgende Verfahrensablauf wird implementiert:
\begin{itemize}
	\item Die Bilder werden eingelesen.
	\item Dann werden die Bildpyramiden (DoG) für SIFT aufgebaut, mittels wiederholt ausgeführtem Gauss-Filter und Downsampling.
	\item In der Folge werden mittels SIFT die Keypoint-Descriptions erstellt.

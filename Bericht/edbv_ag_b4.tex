...
\begin{itemize}
	...
	\item Werden die Bilder korrekt zusammengefügt? 
		Abhängig von der perspektivischen Verzerrung der Bilder funktioniert das Image Stitching generell gut bis sehr gut. In Bildbereichen, in denen keine Matches gefunden werden, können die Übergänge jedoch fehlerhaft sein.
	...
	\item Welche Bilddaten / Szenen sind ungünstig für den Erfolg des Verfahrens? 
		Das rechte Bild darf keine Bereiche darstellen, die links vom linken Bild liegen. Perspektivische Verzerrungen führen ebenfalls zu Fehlern, Rotationen dürfen also lediglich in der xy-Ebene stattfinden. Dazu sind unterschiedliche oder schlechte Lichtverhältnisse, wie z.B. am Abend vorherrschende, problematisch.
	\item Ist das GUI intuitiv aufgebaut?

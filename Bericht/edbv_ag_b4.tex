...
\begin{figure}
\includegraphics{strand.png}
\caption{strand: links und rechts}
\label{strand}
\end{figure}

\begin{figure}
\includegraphics{strandS.png}
\caption{strand: stitched}
\label{strandS}
\end{figure}

\begin{figure}
\includegraphics{bunt.png}
\caption{bunt: links und rechts}
\label{bunt}
\end{figure}

\begin{figure}
\includegraphics{buntS.png}
\caption{bunt: stitched}
\label{buntS}
\end{figure}

\begin{figure}
\includegraphics{tower.png}
\caption{tower: links und rechts}
\label{tower}
\end{figure}

\begin{figure}
\includegraphics{towerS.png}
\caption{tower: stitched}
\label{towerS}
\end{figure}

\begin{figure}
\includegraphics{sanmiguelito.png}
\caption{sanmiguelito: links und rechts}
\label{sanmiguelito}
\end{figure}

\begin{figure}
\includegraphics{sanmiguelitoS.png}
\caption{sanmiguelito: stitched}
\label{sanmiguelitoS}
\end{figure}

\begin{figure}
\includegraphics{skyline.png}
\caption{skyline: links und rechts}
\label{skyline}
\end{figure}

\begin{figure}
\includegraphics{skylineS.png}
\caption{skyline: stitched}
\label{skylineS}
\end{figure}

\begin{figure}
\includegraphics{munich.png}
\caption{munich: links und rechts}
\label{munich}
\end{figure}

\begin{figure}
\includegraphics{munichS.png}
...
\begin{figure}
\includegraphics{demoS.png}
\caption{demo: stitched}
\label{demoS}
\end{figure}

\begin{figure}
\includegraphics{winter.png}
\caption{winter: links und rechts}
\label{winter}
\end{figure}

\begin{figure}
\includegraphics{winterS.png}
...
\begin{itemize}
	...
	\item Werden die Bilder korrekt zusammengefügt? 
		Abhängig von der perspektivischen Verzerrung der Bilder funktioniert das Image Stitching generell gut bis sehr gut (siehe \figref{strand} und \figref{strandS} bzw \figref{skyline} und \figref{skylineS}). In Bildbereichen, in denen keine Matches gefunden werden, können die Übergänge jedoch teilweise fehlerhaft sein (siehe \figref{winter} und \figref{winterS} bzw \figref{demo} und \figref{demoS}).
	...
	\item Welche Bilddaten / Szenen sind ungünstig für den Erfolg des Verfahrens? 
		Das rechte Bild darf keine Bereiche darstellen, die links vom linken Bild liegen (siehe \figref{sanmiguelito} und \figref{sanmiguelitoS}). Perspektivische Verzerrungen führen ebenfalls zu Fehlern, Rotationen dürfen also lediglich in der xy-Ebene stattfinden (siehe \figref{munich} und \figref{munichS}). Dazu sind unterschiedliche oder schlechte , wie z.B. am Abend vorherrschende, Lichtverhältnisse problematisch.
	\item Ist das GUI intuitiv aufgebaut?

...
Im Zuge unserer Arbeit wurden diese Vorgaben geringfügig erweitert, jedoch im Allgemeinen eingehalten. Unsere Erwartungen, dass unser Programm nicht mit dem Originalalgorithmus vergleichbar sein würde, wurden bestätigt. \\\\
...
Insgesamt sind wir jedoch zufrieden mit dem Ergebnis!\\
Ich bin ein positiver Satz.
%%------------------------------------------------------

...
\subtitle{EDBV WS 2014/2015: AG\_XX} %%statt XX Arbeitsgruppenbezeichnung hier eintragen (zB.: A1)
...
Welche Methodik wurde verwendet? Warum eignet sich diese Methodik für die gewählte Problemstellung? etc.\\
...
Ein Beispielsatz (inkl. entsprechender Literaturangabe am Ende des Berichts): Interest Points wurden mittels Scale Invariant Feature Transform \cite{lowe2004} detektier.\\
